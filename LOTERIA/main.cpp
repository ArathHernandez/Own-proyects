...
// FUNCION PARA REVISAR EL NÚMERO QUE SE GRITÓ

void revisarNUM(int arrF[], int n, int &v, int &x, int y, int &z, int &m) // FUNCION PARA REVISAR EL NÚMERO QUE SE GRITÓ
{
...
void revisarTABLA(int matriz[][4], int n) // FUNCION HECHA PARA REVISAR SI EL NUMERO QUE SE TECLEÓ APARECE EN LA TABLA
{
    for(int i=0; i<4; i++)
    {
        for(int j=0; j<4; j++)
...
int main()
{
    ...
    int tamGan; // TAMAÑO DEL ARRAY QUE SE DESPLEGARÁ
